angular.module('Volusion.controllers')
    .controller('ProductCtrl', [ 'api', 'product', '$rootScope', '$scope', '$stateParams', '$sce', '$anchorScroll', '$location',
        function (api, product, $rootScope, $scope, $stateParams, $sce, $anchorScroll, $location) {
            'use strict';
